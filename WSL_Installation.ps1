...
function Install-Ubuntu {
    ...
    $scriptUrl = "https://raw.githubusercontent.com/Doppelp0int/batch/refs/heads/main/WSL_install.sh"
    $outputPath = "C:\temp\WSL_install.sh"
    ...
    wsl -u root bash -c "cd /mnt/c/temp && bash ./WSL_Install.sh"
